...
namespace RestFixture.Net.Support.Http
{
	...
	/// 
	/// </summary>
	public class TraceMethod : org.apache.commons.httpclient.methods.TraceMethod
	{

		/// <summary>
		/// A no args constructor to allow creation. The Uri will be set later for the <seealso cref="RestClient"/> implementation.
		/// </summary>
		public TraceMethod() : base("http://dummy.com")
		{
		}
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
		public virtual URI URI
		{
			...
			set
			{
				(new URIBuilder()).setURI(this, value);
			}
		}
